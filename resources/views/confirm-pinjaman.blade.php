...
@section('title','Konfirmasi Pinjaman')

@section('content')
	<div class="container">
		<div class="row">
			<div class="col-xl-8 col-lg-10 offset-xl-2 offset-lg-1">
				<h4 class="pb-2">Konfirmasi Pinjaman</h4>
				<div class="card card-custom hide" id="data">
					<form id="form" class="card-body">
						...
						<div class="form-group row">
							<label for="message" class="col-lg-4 col-md-5 col-form-label text-secondary">Bulan</label>
							<div class="col-lg-8 col-md-7">
...
@section('script')
	...
	<script>const pinjaman = '{{Request::route("pinjaman")}}'</script>
	<script>const id = '{{Request::route("id")}}'</script>
	<script src="{{asset('assets/js/number.js')}}"></script>
	<script src="{{asset('assets/js/file.js')}}"></script>
	<script src="{{asset('api/confirm-pinjaman.js')}}"></script>
@endsection